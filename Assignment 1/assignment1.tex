...
\raggedright{The expression from the above k-map is XZ}\\
\centering
\begin{kvmap}
    \begin{kvmatrix}{Z,W,X,Y}
    0 & 0 & 0 & 1\\
...
\\2. By solving Table 5.2 we get the second term as XW\\
3. By solving the k-map in Table 5.3, we get the third term as XZ\\
4. By Solving Table 5.3 we get the fourth term as YZ\\
5. From the Table 5.5 we get the last term as ZW' \\
\
\\Finally we get the simplified boolean expression below\\
\centering
